...
describe('server assessment scoring', () => {
  it('aprova avaliação totalmente automática acima da nota mínima', () => {
  ...
  it('encaminha resposta aberta para revisão manual sem fechar nota final', () => {
    const result = scoreAssessment([
      { id: 'q1', type: 'multiple_choice', points: 5, correctOptionIds: ['a'] },
  ...
  it('exige combinação exata em questão com múltiplas alternativas corretas', () => {
    const result = scoreAssessment([
