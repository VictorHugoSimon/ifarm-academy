export interface Env {
  ...
  ACADEMY_CORE_API_URL?: string
  ACADEMY_CORE_REQUEST_TIMEOUT_MS?: string
  ACADEMY_COMMERCIAL_WORKER_SECRET?: string
  ACADEMY_COMMERCIAL_WORKER_MAX_ATTEMPTS?: string
  ACADEMY_COMMERCIAL_WORKER_CLAIM_TTL_SECONDS?: string
  ACADEMY_PAYMENT_WORKER_SECRET?: string
  ACADEMY_PAYMENT_RECONCILE_MAX_ATTEMPTS?: string
  ACADEMY_PAYMENT_RECONCILE_CLAIM_TTL_SECONDS?: string
  ACADEMY_PAYMENT_RECONCILE_BATCH_SIZE?: string
