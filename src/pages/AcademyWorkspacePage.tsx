...
const academyAdminViews = new Set<WorkspaceView>([
  'course', 'quiz', 'publication', 'public-portal', 'public-discovery', 'partners-bundles', 'plans',
