    ...
    <div className="academyWorkspace">
      <div className="workspaceHeader">
        <div>
          ...
          <p className="workspaceIntro">Criação, avaliação, publicação, portal público, trilhas, instrutores, planos, motor comercial consentido, privacidade comercial, matrícula, educação corporativa, eventos, Smart Farm Experience, marketplace, white label, governança técnica, relatórios, observabilidade, experiência do aluno, Tutor IA, gamificação, notificações, revisão e certificação no mesmo fluxo.</p>
        </div>
      </div>
